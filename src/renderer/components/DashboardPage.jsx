      ...
      <div className="space-y-6 p-6">
        ...
        <section className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500">{data?.totalProducts || 0} active items</p>
            </div>
          </button>
        ...
        <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className={`rounded-xl border bg-white p-5 shadow-xs border-l-4 ${
            lowStockCount > 0 ? "border-l-red-500 border-red-200" : "border-l-slate-300 border-slate-200"
          }`}>
            <p className="text-xs font-medium text-slate-500">Low Stock Alert</p>
            <p className={`mt-1.5 text-2xl font-bold ${lowStockCount > 0 ? "text-red-600" : "text-slate-900"}`}>
              {lowStockCount} items
            </p>
                ...
                data?.lowStockProducts?.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      >
                        {item.stockQuantity <= 0 ? "Out of stock" : `${item.stockQuantity} ${item.unit} left`}
                      </span>
